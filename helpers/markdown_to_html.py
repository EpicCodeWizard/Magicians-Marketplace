# /nix/store/bwxril521b35zlf4x2g32hll64rzfhck-nodejs-16.7.0/bin/npm i juice
# fonts.html
# inliner.js
# styles.html
...
import subprocess
import tempfile
styles_file = open("/home/runner/Magicians-Marketplace/helpers/styles.html", "r")
styles = styles_file.read()

fonts_file = open("/home/runner/Magicians-Marketplace/helpers/fonts.html", "r")
...
def markdown_to_html(markdown):
  ...
  finlist = []
  ok = False
  for x in subprocess.check_output(["/nix/store/bwxril521b35zlf4x2g32hll64rzfhck-nodejs-16.7.0/bin/node", "/home/runner/Magicians-Marketplace/helpers/inliner.js", tmpfile.name]).decode("utf-8").strip().split("\n"):
    if x == "</style>":
      ok = True
      continue
    if ok:
